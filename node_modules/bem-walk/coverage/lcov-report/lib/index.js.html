...
<div class="header medium">
    ...
    <h2>
        ...
        Branches: <span class="metric">63.89% <small>(23 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">80% <small>(8 / 10)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">76.79% <small>(43 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var fs = require('fs'),
    ...
    sep = path.sep;
&nbsp;
<span class="fstat-no" title="function not covered" >function set(obj, prop, value) {</span>
...
&nbsp;
        function walk(dir, callback) {
            fs.readdir(dir, function (err, items) {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (err) { <span class="cstat-no" title="statement not covered" >return; </span>}
&nbsp;
                var n = 0,
                    l = items.length;
&nbsp;
...
&nbsp;
                function done(err) {
                    err &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >callback(err);</span>
&nbsp;
...
&nbsp;
                Object.defineProperty(obj, 'copy', {
                    get: <span class="fstat-no" title="function not covered" >function (target) {</span>
<span class="cstat-no" title="statement not covered" >                        if (typeof target !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >                            throw new Error('Target object should be instance of Object, not ' + typeof target);</span>
                        }
&nbsp;
<span class="cstat-no" title="statement not covered" >                        var props = ['block', 'elem', 'modName', 'modVal'];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                            if (target[prop]) { <span class="cstat-no" title="statement not covered" >break; </span>}</span>
<span class="cstat-no" title="statement not covered" >                            set(target, prop, target[prop] || this[prop]);</span>
                        }
&nbsp;
<span class="cstat-no" title="statement not covered" >                        target.tech = target.tech || this.tech;</span>
<span class="cstat-no" title="statement not covered" >                        target.path = this.path;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            output.emit('error', err);</span>
        }
&nbsp;
        ++n === l &amp;&amp; output.end();
    }
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Nov 16 2014 13:14:26 GMT+0300 (MSK)</div>
</div>
